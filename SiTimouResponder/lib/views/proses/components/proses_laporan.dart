...
class ProsesLaporanPage extends StatelessWidget {
  ProsesLaporanPage({super.key});
...
Widget infoPelapor() {
  final controller = Get.find<ProsesController>();
  var fotoPelapor = "${g.apiUrl}/home/foto_profil_pengguna/${controller.detailLaporan.value.userId}";
  // var imgUrl = "${g.apiUrl}/lapor/foto_lokasi/${controller.detailLaporan.value.laporanId}";
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    controller.detailLaporan.value.namaPelapor.toString(),
                    maxLines: 1,
                    softWrap: false,
                    overflow: TextOverflow.ellipsis,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        controller.detailLaporan.value.nik.toString(),
                        maxLines: 1,
                        softWrap: false,
                        overflow: TextOverflow.ellipsis,
                        style: const TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      Icon(
                        controller.detailLaporan.value.jenisKelamin == "LAKI-LAKI" ? Icons.male_sharp : Icons.female_sharp,
                        size: 17.0,
                        color: Colors.purple,
                      ),
                      const SizedBox(width: 7.0),
                      Text(
                        controller.detailLaporan.value.jenisKelamin.toString(),
                        maxLines: 1,
                        softWrap: false,
                        overflow: TextOverflow.ellipsis,
                        style: const TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 7.0),
                      Text(
                        controller.detailLaporan.value.umur != null ? "${controller.detailLaporan.value.umur} Tahun" : "-",
                        maxLines: 1,
                        softWrap: false,
                        overflow: TextOverflow.ellipsis,
                        style: const TextStyle(
                  ...
                  GestureDetector(
                    onTap: () {
                      if (controller.detailLaporan.value.noTelp == null) return;

                      var uri = Uri.parse("tel://${controller.detailLaporan.value.noTelp}");
                      launchUrl(uri);
                    },
                    child: Row(
                      //crossAxisAlignment: Crossaxis,
                      children: [
                        ...
                        const SizedBox(width: 7.0),
                        Text(
                          controller.detailLaporan.value.noTelp != null ? "${controller.detailLaporan.value.noTelp}" : "-",
                          maxLines: 1,
                          softWrap: false,
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(
                            color: controller.detailLaporan.value.noTelp == null ? Colors.black54 : const Color.fromARGB(255, 0, 180, 6),
                            fontSize: 13.0,
                            fontWeight: FontWeight.w500,
                          ),
                        ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          "${controller.detailLaporan.value.alamat}, Desa/Kel. ${controller.detailLaporan.value.namaDesa}, Kec. ${controller.detailLaporan.value.namaKecamatan}",
                          maxLines: 2,
                          softWrap: true,
                          overflow: TextOverflow.ellipsis,
                          style: const TextStyle(
              ...
              children: [
                SizedBox(
                  ...
                  child: SleekButton(
                    ...
                    onTap: () {
                      //Get.back();
                      controller.prosesLaporan(context, "1", "B");
                    },
                  ),
                ),
                const SizedBox(width: 35.0),
                SizedBox(
                  ...
                  child: SleekButton(
                    ...
                    onTap: () {
                      controller.prosesLaporan(context, "1", "S");
                    },
                  ),
                ),
              ],
