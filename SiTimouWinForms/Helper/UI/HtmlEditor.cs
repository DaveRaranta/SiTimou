...
namespace gov.minahasa.sitimou.Helper.UI
{
    public partial class HtmlEditor : UserControl
    {
        ...
        private bool _updatingFontName = false;
        private bool _updatingFontSize = false;
        ...
        public bool CanCut()
        {
            return _doc.queryCommandEnabled("Cut");
        }
        ...
        public bool CanCopy()
        {
            return _doc.queryCommandEnabled("Copy");
        }
        ...
        {
            return _doc.queryCommandEnabled("Paste");
        }
        ...
        {
            return _doc.queryCommandEnabled("Delete");
        }
        ...
        {
            foreach (HTMLImg image in _doc.images)
            {
                if (image != null)
                {
        ...
        {
            IHTMLTxtRange range =
                _doc.selection.createRange() as IHTMLTxtRange;
            range.pasteHTML("<br/>");
        ...
        public SelectionType SelectionType
        {
            get
            {
                var type = _doc.selection.type.ToLower();
                switch (type)
                {
                    case "text":
        ...
        public FontSize FontSize
        {
            get
            {
                if (ReadyState != ReadyState.Complete)
                    return FontSize.NA;
                string fs = _doc.queryCommandValue("FontSize").ToString();
                switch (fs)
                {
                    case "1":
                        return FontSize.One;
        ...
        public FontFamily FontName
        {
            get
            {
                if (ReadyState != ReadyState.Complete)
                    return null;
                string name = _doc.queryCommandValue("FontName") as string;
        ...
        public Color EditorForeColor
        {
            get
            {
                if (ReadyState != ReadyState.Complete)
                    return Color.Black;
                return ConvertToColor(_doc.queryCommandValue("ForeColor").ToString());
            }
            set
            {
                string colorstr =
        ...
        public Color EditorBackColor
        {
            get
            {
                if (ReadyState != ReadyState.Complete)
                    return Color.White;
                return ConvertToColor(_doc.queryCommandValue("BackColor").ToString());
            }
            set
            {
                string colorstr =
        ...
        private bool LinksInSelection()
        {
            ...
            IHTMLTxtRange txtRange = (IHTMLTxtRange)_doc.selection.createRange();
            ...
            {
                string type = _doc.selection.type;
            }
