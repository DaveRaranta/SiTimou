...
{
    public sealed partial class DisposisiPanikOpd : Form
    {
        #region === Constructor ===
        ...
        private void ButtonSimpan_Click(object sender, EventArgs e)
        {
            ...
            var result = _controller.SimpanLaporanOpd("2", IdLaporan, win.IdPenerima, IdDisposisiOpd, this);

            if (!result)
            {
                _notifHelper.MsgBoxWarning("Gagal disposisi laporan Panik. Hubungi admin untuk info selanjutnya.");
                return;
            }
